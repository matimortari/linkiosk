    ...
    <div class="container mx-auto grid w-full grid-cols-1 items-center justify-items-center gap-8 md:grid-cols-2">
      <div class="order-1 flex items-center justify-center">
        <div class="relative grid grid-cols-2 gap-2">
          <div
            ...
            class="card flex h-28 w-40 flex-col justify-between"
          ...
          >
            ...
            <div class="flex flex-col items-start gap-1 text-start">
              ...
              <span class="text-xs text-white/50">linkiosk.app/alex</span>
            </div>
          </div>

          <div class="absolute -right-20 -bottom-3 navigation-group gap-1.5 rounded-full border bg-card px-3 py-1.5 whitespace-nowrap shadow-sm" style="z-index: 10;">
      ...
      <div class="order-2 flex flex-col gap-4 text-start">
        <p class="text-lead">
          ...
          Whether you're a creator, business, or influencer, LinKiosk makes it easy
          to share and connect with your audience across platforms and in person.
        </p>
